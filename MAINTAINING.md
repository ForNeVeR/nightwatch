...
3. Update the existing or create a new key named `nightwatch.github` with a permission to **Push only new package versions** with a glob pattern of `FVNever.Nightwatch*`.
